...
contract NoReserveV {
    ...
    function addLiquidity(uint _amount0, uint _amount1) external returns (uint shares) {
        uint reserve0 = getToken0Reserve();
        uint reserve1 = getToken1Reserve();
    ...
    function removeLiquidity(uint _shares) external returns (uint d0, uint d1) {
        ...
        uint reserve0 = this.getToken0Reserve();
        uint reserve1 = this.getToken1Reserve();
        d0 = (reserve0 * _shares) / totalSupply;
        d1 = (reserve1 * _shares) / totalSupply;
    ...
    function getToken0Reserve() public view returns (uint amount) {
        amount = token0.balanceOf(address(this));
    }

    function getToken1Reserve() public view returns (uint) {
